...
public class MapMatchingUtil {
	...
	public static OSMNode doMatching(Collection<Vertex> vertexs,String gpsLat,
		...
		for (Vertex vertex : vertexs) {
			...
			double jarak = LatLongUtil.distance(Double.parseDouble(gpsLat), Double.parseDouble(gpsLon),
...
//				+ LatLongUtil.distance(Double.parseDouble(gpsLat), Double.parseDouble(gpsLon),
